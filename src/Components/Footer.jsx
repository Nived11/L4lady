      ...
      <div className="footer-container">
        <div className="footer-content">
          ...
          <div className="footer-section footer-logo-section">
            <img src={logo} alt="L4LADY Logo" className="footer-logo" />
            <div className="footer-tagline">Forever for women</div>
            <p className="footer-description">
              Discover timeless elegance and contemporary style. Where fashion
              meets sophistication for the modern woman.
            </p>
          </div>
          ...
          <div className="footer-section">
            <h3>About Us</h3>
            <p className="footer-description">
              L4 Lady Creations is dedicated to empowering women through
              fashion. We believe every woman deserves to feel confident and
              beautiful in what she wears. Our carefully curated collections
              blend timeless elegance with contemporary trends, creating pieces
              that celebrate the unique spirit of every woman.
            </p>
          </div>
          ...
          <div className="footer-section">
            ...
            <div className="footer-contact">
              ...
              <div className="contact-item">
                ...
                <a href="tel:9496832645" className="contact-link">
                  +91 9496832645
                </a>
              </div>
              <div className="contact-item">
